...
function sendInputToGAS3(message, isUserMessage) {
    const GAS_URL3 = 'https://script.google.com/macros/s/AKfycby5WA5xYPn0sPjQLr2cgw2Xvi_Fi9GrJ1oPNBwJd4LJ8adpZlI8KU7Fo7SvRc22_Olg/exec'; // Replace with your actual URL
...
function startConversation() {
    fetch('https://chatbot-for-etobicoke-montessori-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
  ...
  //sendInputToGAS3(userMessage, true);
    ...
    fetch('https://chatbot-for-etobicoke-montessori-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGAS(message, isUserMessage) {
    var GAS_URL = 'https://script.google.com/macros/s/AKfycbwnwYFqGNF-E9TPFj73-J8XZ4rsohPBVTwYGXRvGmvpDAb7-5f42L8E6umzEJOUcMbYFw/exec';
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbzfTZzttAyyGKehfQ6F5SfwBkuP-mVab29Q0yEPsBhq2eC0xFkBvF7DyTbPQIkkV8rm/exec';
